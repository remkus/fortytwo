 ...
 */
function fortytwo_html5_genesis_standard_loop() {
...
add_action( 'genesis_before_post_content', 'fortytwo_post_info' );
/**
...
add_action( 'genesis_sidebar', 'fortytwo_genesis_do_sidebar' );
/**
 * Echo primary sidebar default content.
 *
 * @since 1.0
 */
function fortytwo_genesis_do_sidebar() {
...
add_action( 'genesis_footer', 'fortytwo_genesis_footer_markup_open', 5 );
/**
 ...
 */
function fortytwo_genesis_footer_markup_open() {
...
add_action( 'genesis_footer', 'fortytwo_genesis_footer_markup_close', 15 );
/**
 ...
 */
function fortytwo_genesis_footer_markup_close() {
