...
function fortytwo_load_google_fonts() {
    ...
    wp_enqueue_style( 'google-font-open-sans-condensed', 'http://fonts.googleapis.com/css?family=Open+Sans+Condensed:300,300italic,700', array(), PARENT_THEME_VERSION );
}
