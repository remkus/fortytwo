...
function genesis_responsive_slider_scripts() {
	...
	wp_enqueue_script( 'flexslider', modules_url('js/jquery.flexslider.js', __FILE__), array( 'jquery' ), GENESIS_RESPONSIVE_SLIDER_VERSION, TRUE );
...
function genesis_responsive_slider_styles() {
	...
	wp_register_style( 'slider_styles', modules_url('style.css', __FILE__), array(), GENESIS_RESPONSIVE_SLIDER_VERSION );
