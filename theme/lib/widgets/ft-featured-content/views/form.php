...
<table style="width: 100%">
	<tr>
		...
		<td>
			<label for="<?php echo $this->get_field_id( 'link_text' ); ?>"><?php _e( 'Title:', 'fortytwo', 'fortytwo-dev' ); ?></label>
			<input class="widefat" type="text"<?php $this->id_name( 'title' ); ?> value="<?php echo esc_attr( $instance['title'] ); ?>">
		</td>
  </tr>
	<tr><td colspan="2">
			<label for="<?php echo $this->get_field_id( 'link_text' ); ?>"><?php _e( 'Content:', 'fortytwo', 'fortytwo-dev' ); ?></label>
	...
	<tr><td colspan="2">
		  ...
		  <label for="<?php echo $this->get_field_id( 'link_text' ); ?>"><?php _e( 'Link URL:', 'fortytwo', 'fortytwo-dev' ); ?></label>
