...
?>
<p>
<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title', 'fortytwo', 'fortytwo-dev' ); ?>:</label><br />
<input type="text"<?php $this->id_name( 'title' ); ?> value="<?php echo esc_attr( $instance['title'] ); ?>" class="widefat" />
</p>

<p>
<label for="<?php echo $this->get_field_id( 'name' ); ?>"><?php _e( 'Company Name', 'fortytwo', 'fortytwo-dev' ); ?>:</label><br />
<input type="text"<?php $this->id_name( 'name' ); ?> value="<?php echo esc_attr( $instance['name'] ); ?>" class="widefat" />
</p>

<p>
<label for="<?php echo $this->get_field_id( 'address' ); ?>"><?php _e( 'Address', 'fortytwo', 'fortytwo-dev' ); ?>:</label><br />
<input type="text"<?php $this->id_name( 'address' ); ?> value="<?php echo esc_attr( $instance['address'] ); ?>" class="widefat" />
</p>

<p>
<label for="<?php echo $this->get_field_id( 'pc' ); ?>"><?php _e( 'Postal Code', 'fortytwo', 'fortytwo-dev' ); ?>:</label><br />
<input type="text"<?php $this->id_name( 'pc' ); ?> value="<?php echo esc_attr( $instance['pc'] ); ?>" class="widefat" />
</p>

<p>
<label for="<?php echo $this->get_field_id( 'city' ); ?>"><?php _e( 'City, Country', 'fortytwo', 'fortytwo-dev' ); ?>:</label><br />
<input type="text"<?php $this->id_name( 'city' ); ?> value="<?php echo esc_attr( $instance['city'] ); ?>" class="widefat" />
</p>

<p>
<label for="<?php echo $this->get_field_id( 'phone' ); ?>"><?php _e( 'Phone', 'fortytwo', 'fortytwo-dev' ); ?>:</label>
<input type="text"<?php $this->id_name( 'phone' ); ?> value="<?php echo esc_attr( $instance['phone'] ); ?>" class="widefat" />
</p>

<p>
<label for="<?php echo $this->get_field_id( 'email' ); ?>"><?php _e( 'Email', 'fortytwo', 'fortytwo-dev' ); ?>:</label>
<input type="text"<?php $this->id_name( 'email' ); ?> value="<?php echo esc_attr( $instance['email'] ); ?>" class="widefat" />
</p>

<p>
<label for="<?php echo $this->get_field_id( 'fax' ); ?>"><?php _e( 'Fax', 'fortytwo', 'fortytwo-dev' ); ?>:</label>
